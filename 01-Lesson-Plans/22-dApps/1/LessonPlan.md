...
The full code for the art contract is as follows:
...
* This is how the Streamlit front-end interface for our dApp will eventually access the details of our contract.
...
Ask students if they have any questions about the code to display the token or to build the front-end of the dApp by using Streamlit.
