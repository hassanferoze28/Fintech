...
* Wait for the fit to complete, and then move to the next section. Explain to the students that Prophet requires just one more step to visualize the output from this model training. 
...
In this activity, the students will use time series forecasting to analyze Google Trends data.
...
In this activity, the students will learn how to both visualize Prophet forecasts and interpret the results. Here, you’ll continue using the hourly data for the price of electricity for the areas near Chicago, Illinois.
...
Explain to the students that you’ll continue analyzing the data for the hourly price of electricity in the Chicago, Illinois area. You'll demonstrate how to visualize the Prophet forecast results and interpret them.

Highlight the following details:

* We can start analyzing the predictions by plotting the `forecast` data. Then, we’ll learn what’s happening in more detail.
...
Highlight the following information about this overlay plot (note that the colors of the lines may vary from computer to computer):
...
* Using our DataFrame of predictions (both in-sample and out-of-sample), we can use Prophet to analyze the time series patterns by calling the `plot_components` function.
...
* Let’s examine these plots in more detail and then think about how we could present our findings for our scenario.
  ...
  * The third plot indicates that the prices are generally at their highest in July and August,  regardless of the day. This is likely due to increased demand as people and businesses use more air conditioning to cope with summer heat.
...
* We used Prophet to analyze electricity prices and break down price data as an hourly time series. 
...
Summarize and contextualize this activity for the students: 

* Prophet helped us analyze our time series data by breaking down its many patterns and by producing forecasts for patterns in the future. 
...
Open Google Colab, import the unsolved version of the provided notebook, and then live-code the solution. This activity complements the workflow of time-series forecasting with Prophet by allowing us to visualize and then interpret the forecast results.
...
* Next, we analyze the forecast results by using the Pandas `plot` function to plot the “yhat”, “yhat_lower”, and “yhat_upper” columns of the forecast DataFrame for both the Canada and the Uruguay models:
...
* Finally, we use the `plot_components` function on the Prophet models to analyze the patterns of the Google Trends times series data for the Canada and Uruguay models, as the following code shows:
...
### 11. Instructor Do: The Career Team (35 minutes)

**Note:** If you’re teaching this lesson on a weeknight, save this section for the next Saturday class.

**A note on skill diversity:** The fintech student demographic is highly diverse. It consists of students with an extensive financial background, students with some programming experience, and students with little or no experience in either field. Because of this, the students might complete different activities during this section.

#### 11.1 Instructor Do: FinTech Resumes (5 minutes)

Explain to the students that they should update their resumes to showcase their projects and all the new skills they've acquired.

Ask the class the following questions, and call on students for the answers.

* **Question:** Why is it important to showcase your projects?

  * **Answer:** Every employer seeks a portfolio that demonstrates your capability in the fintech field.

* **Question:** Do you know who you can submit your resume to for review?

  * **Answer:** Your Career Material Advisor.

* **Question:**: Where can you submit this to a Career Material Advisor?

  * **Answer:** Bootcamp Spot.

Check if any students have already completed their resume and have submitted it to a Career Material Advisor in the Career Services tab in the campus portal.

Tell the students who haven’t created a resume to use the Career Services resources to do so.

* Students who have a resume but haven't submitted it to a Career Material Advisor should submit it now, and then skip to the **Bonus** activity at the end of this lesson plan.

* Students who have created a resume and already submitted it should skip to the **Bonus** activity.
#### 11.2 Student Do: Identify Your Resume Type (5 minutes)

Let the students know that not everyone in the class has the same objectives or background. They have a variety of experience that can fall into the following categories:

* **Entry level (no experience):** An entry-level student is one who’s taking this course to break into the fintech industry with less than three years of work experience. Their background has nothing to do with fintech. The work that they’re doing in this class is the only work that they can put on their resume to get a job in the fintech industry. They should use the **entry-level/mid-level (no experience)** template to either make a new resume or incorporate components into their previous resume that might be missing.

* **Mid-level (no experience):** A mid-level student with no experience is one who’s worked in a different industry, but their experience has nothing to do with the fintech industry. They should use the **entry-level/mid-level (no experience)** template to either make a new resume or incorporate components into their previous resume that might be missing.

* **Mid-level (relevant experience):** A mid-level student with experience is one who’s worked in the fintech industry and took this course to gain specific skills that can either advance their career or fill gaps in their knowledge. This student has seven or fewer years of experience in the fintech or data industry. They should use the **mid-level (experience)** template to either add to their existing resume or start from scratch.

* **Senior level (no experience):** A senior-level student with no experience is one who has 10 or more years experience in a different industry but no relevant fintech (in-field) experience. They should use the **senior level (no experience)** template to either update their existing resume or create a new one.

* **Senior level (experience):** A senior-level student with in-field experience needs to incorporate the skills that they learned in the classroom into their resume. They should use the **senior level (experience)** template to either update their existing resume or create a new one.

Encourage the students to create a resume that fits their skill and/or experience level. This will give them the greatest chance of gaining employment or the promotion that they seek.

Use the following section to discuss the career services content for this week.

#### 11.3 Student Do: Build Your Resume (25 minutes)

**Files:** [Resume templates](https://careernetwork.2u.com/?utm_medium=Academics&utm_source=boot_camp) (navigate to **Tools and Resources**).

For the next part of the class, the students will work on their resumes.

Slack out the preceding resume templates link, and ask the students to each select the template that best fits their needs. If they already have a resume, encourage them to adapt it to include all the sections from the appropriate template. Explain the following: 

* Every student should submit a completed resume to a Career Material Advisor in Bootcamp Spot by the end of class. 

* Students who are unable to complete their resume on time should submit it to Bootcamp Spot by the end of the week. 

* This will allow all students to get feedback on their work. Career Material Advisors should respond to the students with feedback on their resumes within 96 hours.

#### Bonus: Technical Interview Prep

This activity is not instructor-led. It’s for only those students who have completed their resumes and submitted them to a Career Material Advisor. Slack out the following instructions and link:

```text
Part of interviewing for a fintech role usually means completing a technical assessment. And often, these technical assessments don’t directly relate to fintech concepts but aim to test your abilities in problem solving and programming.

In the following challenge, you’ll use an online technical assessment platform that mirrors platforms used by recruiters and hiring managers to test technical abilities. You’ll complete a timed algorithm challenge in Python named fizzBuzz.

Your instructional team will send the solution to this challenge at the end of class.

Activity link: [CodeSignal challenge: fizzBuzz](https://app.codesignal.com/public-test/vNbgtoSmvDrajGvgo/sne7eLC3dN4kFy)
```

**Note:** Don’t slack out the following solution until the end of class:
