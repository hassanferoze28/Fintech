...
* The **implied volatility** of a stock is a standardized measure of the price of all the options currently trading on the stock. This is a way to backtest options on a stock by using only a single column. This gives us an approximate measure of backtest option returns.
